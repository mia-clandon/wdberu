                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Список желаний</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="#">               
                            <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="product-thumbnail">Товары</th>
                                            <th class="product-name">Название товаров</th>
                                            <th class="product-name">Удалить</th>
                                    ...
                                    <tbody>
										...
										?>
											<tr>
												...
												<td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $row['pid']?>','add')">Добавить в корзину</a></td>
											</tr>
											<?php } ?>
                                    </tbody>
                                </table>
