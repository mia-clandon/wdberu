                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="box-link"><a href="manage_categories.php">Добавить категории</a></h4>
                        </div>
                        <div class="card-body--">
                                    ...
                                    while ($row=mysqli_fetch_assoc($res)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                echo "<span class='badge badge-edit'><a href='manage_categories.php?id=" . $row['id'] . "'>Редактировать</a></span>&nbsp;";
