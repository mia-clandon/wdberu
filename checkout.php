                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Заказать</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="accordion__body__form">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form id="login-form" method="post">
                                                            <h5 class="checkout-method__title">Авторизация</h5>
                                                            <div class="single-input">
                                                                <input type="text" name="login_email" id="login_email" placeholder="Ваш Email*" style="width:100%">
																<span class="field_error" id="login_email_error"></span>
                                                            </div>
															
                                                            <div class="single-input">
                                                                <input type="password" name="login_password" id="login_password" placeholder="Ваш пароль*" style="width:100%">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="checkout-method__login">
                                                        <form action="#">
                                                            <h5 class="checkout-method__title">Регистраия</h5>
                                                            <div class="single-input">
                                                                <input type="text" name="name" id="name" placeholder="Ваше имя*" style="width:100%">
																<span class="field_error" id="name_error"></span>
                                                            </div>
															<div class="single-input">
                                                                <input type="text" name="email" id="email" placeholder="Ваш Email*" style="width:100%">
																<span class="field_error" id="email_error"></span>
                                                            </div>
															
                                                            <div class="single-input">
                                                                <input type="text" name="mobile" id="mobile" placeholder="Номер телефона*" style="width:100%">
																<span class="field_error" id="mobile_error"></span>
                                                            </div>
															<div class="single-input">
                                                                <input type="password" name="password" id="password" placeholder="Пароль*" style="width:100%">
																<span class="field_error" id="password_error"></span>
                                                            </div>
                                                            <div class="dark-btn">
                                                                <button type="button" class="fv-btn" onclick="user_register()">Регистрация</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
										...
										<div class="accordion__body">
											<div class="bilinfo">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="single-input">
																<input type="text" name="address" placeholder="Улица" required>
															</div>
														</div>
														<div class="col-md-6">
															<div class="single-input">
														...
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="pincode" placeholder="Индекс" required>
															</div>
														</div>
