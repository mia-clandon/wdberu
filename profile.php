						...
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Профиль</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="update_profile()" id="btn_submit">Обновить</button>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Изменить пароль</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									<div class="single-contact-form">
										<label class="password_label">Текущий пароль</label>
										<div class="contact-box name">
									...
									<div class="single-contact-form">
										<label class="password_label">Новый пароль</label>
										<div class="contact-box name">
									...
									<div class="single-contact-form">
										<label class="password_label">Повторите новый пароль</label>
										<div class="contact-box name">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="update_password()" id="btn_update_password">Обновить</button>
